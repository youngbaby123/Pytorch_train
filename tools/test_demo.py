...
def all_summary_1():
    ...
    for model_i in model_list_file:
        ...
        res[opt.model_name]["params_num"] = test.summary_params()
        res[opt.model_name]["file_size"] = get_FileSize(opt.test_model)
        # print (res[opt.model_name]["params_num"])
        # print (res[opt.model_name]["params_num"])
        # print (res[opt.model_name]["file_size"])
        # print (res[opt.model_name]["file_size"])
...
def params_test():
    ...
    opt.model_name = "Conv2fc1_avg_32"
    opt.test_model = os.path.join(task_root, "out/car_Conv2fc1_avg_32_1230_40.pth")
    print (get_FileSize(opt.test_model))
    test = test_.test_net(opt)
